...
const AdminLoginWindow = ({ onClose, onMinimize, onFocus, onSuccess, isMinimized, zIndex }) => {
      ...
      <div className="bg-white/95 backdrop-blur-2xl rounded-xl shadow-2xl overflow-hidden border border-white/20">
        ...
        <div className="window-header bg-gradient-to-b from-gray-100 to-gray-50 border-b border-gray-200 px-4 py-3 flex items-center justify-between cursor-grab active:cursor-grabbing">
          ...
          <div className="flex-1 text-center">
            <h2 className="text-sm font-semibold text-gray-700">Admin belépés</h2>
          </div>
        ...
        <div className="p-8">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center border-2 border-blue-200 shadow-lg">
              <svg
          ...
          {/* Username */}
          <h2 className="text-xl font-medium text-center mb-6 text-gray-800">admin</h2>
          ...
          <form onSubmit={handleLogin} data-testid="admin-login-form">
            ...
            {error && (
              <div className="mb-4 text-red-600 text-sm text-center animate-fade-in" data-testid="error-message">
                {error}
              </div>
            )}
            ...
            <button
              ...
              className="w-full py-2 rounded-lg bg-blue-500 hover:bg-blue-600 text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
